...
citation: 'X Ding, X Huang, M Ju, L Collins, Y Liu, L Akoglu, N Shah, T Zhao, Hierarchical Token Prepending: Enhancing Information Flow in Decoder-based LLM Embeddings, ACL 2026 (Oral)'
authors:
  - "Xueying Ding"
  - "Xingyue Huang"
  - "Mingxuan Ju"
